...
from scriptcraft.layers.layer_1_tools.level_1_impl.level_1.git_submodule_tool.operations import pull_submodules, push_submodules, sync_submodules, update_submodules
