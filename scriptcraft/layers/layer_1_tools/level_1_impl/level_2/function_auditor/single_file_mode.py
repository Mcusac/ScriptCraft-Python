...
from layers.layer_1_tools.level_0_infra.level_0.function_auditor.types import InputPath

from layers.layer_1_tools.level_1_impl.level_0.function_auditor.persistence import save_single_audit
