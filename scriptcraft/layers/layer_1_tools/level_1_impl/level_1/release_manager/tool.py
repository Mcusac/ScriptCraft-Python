...
from scriptcraft.layers.layer_1_tools.level_1_impl.level_1 import load_builtin_plugins
...
class ReleaseManager(BaseTool):
    ...
    def _load_custom_plugins(self) -> None:
        """Load custom plugins from plugins directory (custom_*.py contract)."""
        plugins_dir = Path(__file__).parent / "plugins"
        load_custom_plugins(self.workflow_registry, plugins_dir)
