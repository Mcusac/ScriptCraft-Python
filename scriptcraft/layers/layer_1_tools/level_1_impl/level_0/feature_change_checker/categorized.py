"""Categorized visit-to-visit progression analysis for feature change checker."""
...
def run_categorized_changes(
    df: pd.DataFrame,
    feature: str,
    output_dir: Union[str, Path],
) -> None:
    """Run categorized visit-to-visit changes analysis."""
    ...
    log_and_print(
        f"✅ Categorized changes saved to: {output_path.resolve()} ({len(df_out)} rows)"
    )
