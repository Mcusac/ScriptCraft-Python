...
```
scriptcraft/layers/layer_1_pypi/level_1_impl/level_0/function_auditor/
├── __init__.py   # Package interface (exports FunctionAuditor, BatchFunctionAuditor)
├── auditor.py    # Single-file auditing logic
├── batch.py      # Batch auditing + report generation
...
```bash
# Run the ScriptCraft BaseTool integration
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_1.function_auditor_main --help

# Run the standalone function auditor CLI module
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor.cli file.py

# Run with specific language
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor.cli --batch --language python --folder src

# Run with pattern matching
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor.cli --batch --pattern "**/*.py" --language python
```

### Python API (Development)
```python
from scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor import (
    FunctionAuditor,
...
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor.cli tests/data/sample.py

# Test batch processing
python -m scriptcraft.layers.layer_1_pypi.level_1_impl.level_0.function_auditor.cli --batch --language python --folder tests/data
```
