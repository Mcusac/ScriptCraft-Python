...
def test_tool_imports():
    ...
    try:
        from scriptcraft.layers.layer_1_tools.level_1_impl import get_available_tools
...
def test_base_functionality():
    ...
    try:
        from scriptcraft.layers.layer_1_tools.level_0_infra.level_0.logging_core import log_and_print
