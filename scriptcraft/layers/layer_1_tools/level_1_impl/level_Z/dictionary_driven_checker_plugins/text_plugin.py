...
from scriptcraft.layers.layer_1_tools.level_0_infra.level_2 import FlaggedValue, ColumnValidator
...
# Load configuration
config = load_config()
text_config = config.dictionary_checker.get("text_validation", {})
