...
from scriptcraft.layers.layer_1_tools.level_0_infra.level_1 import clean_dataframe, DataProcessor

_data_processor = DataProcessor()


def process_domain_data(domain_df, domain, **kwargs):
    _ = domain, kwargs
    return clean_dataframe(domain_df)
...
def prepare_supplements(
    ...
    **kwargs: Any,
    ...
    if output_path:
        ...
        _data_processor.save_results(merged_data, output_path)
...
def split_supplements_by_domain(
    ...
    **kwargs: Any,
    ...
    for domain in domains:
        ...
        _data_processor.save_results(domain_df, domain_path)
